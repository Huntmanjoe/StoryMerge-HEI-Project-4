...
if __name__ == '__main__':
    ...
    with app.app_context():
       ...
       narcissus = Prompt(title='Narcissus and Goldmund',
               content='A young man, Goldmund, wanders aimlessly throughout Medieval Germany after leaving a Catholic monastery school in search of what could be described as "the meaning of life".',
               user_id=hesse.id)
